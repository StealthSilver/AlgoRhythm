...
function Category({ name, delay }: CategoryProps) {
  ...
  return (
    <div
      ref={categoryRef}
      className={`group relative px-8 py-6 rounded-xl backdrop-blur-sm cursor-pointer transition-all duration-500 ${
        isVisible
    ...
    >
      ...
      <div className="relative z-10 flex items-center justify-between">
        ...
        <svg
          className="w-5 h-5 text-[rgb(141,118,233)] opacity-0 group-hover:opacity-100 transform translate-x-0 group-hover:translate-x-2 transition-all duration-300"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
